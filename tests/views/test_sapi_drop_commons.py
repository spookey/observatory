...
PAGES = [
    ...
    page_data(
        ...
        keys=[
            ...
            'sensors.radiation.alpha.value.horizon',
    ...
    page_data(
        ...
        keys=[
            ...
            'sensors.radiation.beta.value.horizon',
    ...
    page_data(
        ...
        keys=[
            ...
            'sensors.radiation.gamma.value.horizon',
    ...
    page_data(
        ...
        keys=[
            ...
            'sensors.radiation.beta_gamma.value.horizon',
